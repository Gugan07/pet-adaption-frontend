...
const faqs = [
  ...
  { q: 'Is adoption free?',                a: 'Many pets on PetSphere are available for free adoption. Some sellers may charge a small fee to cover vaccination and health check costs. The listing will clearly show if there\'s a fee.' },
  ...
  { q: 'Are the sellers verified?',        a: 'Yes. Every seller on PetSphere goes through an identity verification process. We also collect reviews from buyers to maintain quality and trust on our platform.' },
  { q: 'What if I have issues after adoption?', a: 'Our support team is available Monday to Friday, 9am–6pm. You can reach us via the Contact page or email us at hello@petsphere.com.' },
  ...
  return (
    <>
      ...
      <div className="page-header">
        ...
        <p>Find answers to the most common questions about PetSphere.</p>
      </div>
